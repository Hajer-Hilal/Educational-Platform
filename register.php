...
<html>
  <head>
    <meta charset="utf-8">
    <title>Form</title>
    <link href="css/styreg.css" type="text/css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  </head>
  <body>
    <!-- Body of Form starts -->
  	<div class="container">
      <form  action="chk.php" method="post" autocomplete="on">
        <!--First name-->
    		<div class="box">
        ...
        <!--Second name-->
          ...
          <label for="gender" class="fl fontLabel"> Gender: </label>
            ...
            <p style=color:green><?php if(isset($_GET['msg1'])){echo $_GET['msg1'];}  ?></p>
    		<!---Submit Button----->
      </form>
  </div>
  <!--Body of Form ends--->
