              ...
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <?php
                  if(isset($_SESSION['id'])){
                    ...
                    include("config.php");
                    $sql1="SELECT id,Email FROM student WHERE type='1' ";
                    ...
                    if($i_session==$row['id'])
                    {
                     $id=$row['id'];
                             ...
                             $_SESSION['id_ins']=$id;
                      echo '<li><a href="dashbord_ins.php" class="nav-link">Dashbord</a></li>';
                    //  break;
                    }}
                  }
                if(isset($_SESSION['admin']))
                {
                  echo '<li><a href="dashbord_admin.php" class="nav-link">Dashbord</a></li>';
                } 
                ?>
                <!-- <li><a href="dashbord.php" class="nav-link">Dashbord</a></li> -->
          ...
          <div class="ml-auto w-25">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="be_ins.php" class="nav-link"><span>كن معلم</span></a></li>
              </ul>
            </nav>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                ...
                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="chk.php" method="post" class="form-box">
                    ...
                    <div class="form-group">
                      <input type="submit" name="login" class="btn btn-primary btn-pill" value="Sign up">
                    </div>
                    <label>
                     <input type="checkbox" checked="checked" name="remember"> Remember me
                    </label>
                    <a class="cr" href="register.php">new create acount</a>
                  </form>
